...
const resources = {
  en: {
    translation: {
      ...
      // Discover Page
      "discover.title": "Discover Artisan Crafts",
      "discover.subtitle": "Find unique handmade treasures from skilled artisans across India",
      "discover.tabs.discover": "Discover",
      "discover.tabs.search": "Search & Filter",
      "discover.tabs.ai": "AI Recommendations",
      "discover.loading": "Generating personalized recommendations...",
      "discover.refresh": "Refresh AI Recommendations",

      // AI Hub
      "aihub.title": "AI Hub",
      "aihub.lead": "Explore DOTS AI tools designed to help artisans and buyers with creation, recommendations, and pricing.",
      "aihub.cta": "Start with Listing Copilot",
      "aihub.open": "Open",
      "aihub.badge.artisan": "Artisan",
      "aihub.badge.all": "All Users",
      "aihub.tools.listingCopilot.title": "Listing Copilot",
      "aihub.tools.listingCopilot.desc": "Generate titles, descriptions, and tags with AI assistance.",
      "aihub.tools.customImage.title": "Custom Image Requests",
      "aihub.tools.customImage.desc": "Create product images or captions using AI models.",
      "aihub.tools.aiRecommendations.title": "AI Recommendations",
      "aihub.tools.aiRecommendations.desc": "Discover products uniquely tailored to your preferences.",
      "aihub.tools.pricingOptimizer.title": "Pricing Optimizer",
      "aihub.tools.pricingOptimizer.desc": "Optimize pricing with guardrails to protect your brand.",
      "aihub.tools.strategyInsights.title": "AI Strategy Insights",
      "aihub.tools.strategyInsights.desc": "Data-driven strategy suggestions personalized to your shop.",
