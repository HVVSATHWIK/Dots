...
export default [
  ...
  'custom/no-direct-firestore': 'error',
      ...
      'no-restricted-syntax': [
        'error',
        {
          selector: 'JSXElement[openingElement.name.name="SelectItem"] JSXAttribute[name.name="value"][value.type="Literal"][value.value=""]',
          message: 'SelectItem must not have an empty string value prop. Use a non-empty string like "all" instead.',
        },
        {
